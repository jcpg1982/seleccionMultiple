...
public class ListSolicPermFragmentPresenter extends BasePresenter<IListSolicPermFragmentContract.View>
        implements IListSolicPermFragmentContract.Presenter {

    String TAG = ListSolicPermFragmentPresenter.class.getSimpleName();
    ...
    @Inject
    public ListSolicPermFragmentPresenter() {
    ...
    public void setResultListSolicPers(ResultListSolicPers resultListSolicPers) {
        ...
        mRequestListSolicPers.setIntTipoUso(0);
    ...
    public List<SolicitudesPermiso> getDataDummyListPerm() {
      ...
      /*  SolicitudesPermiso s1 = new SolicitudesPermiso("12345678",
                "1", "1982/05/24", "2020/05/24",
                "00:00", "05:00", 1, 1,
                "Quiero permiso", "1", "supervisor@mail.com",
                1, 1, 1);
        SolicitudesPermiso s2 = new SolicitudesPermiso("12345679",
                "1", "1982/05/24", "2020/05/24",
                "00:00", "05:00", 1, 1,
                "Quiero permiso", "1", "supervisor@mail.com",
                1, 1, 1);
        SolicitudesPermiso s3 = new SolicitudesPermiso("12345680",
                "1", "1982/05/24", "2020/05/24",
                "00:00", "05:00", 1, 1,
                "Quiero permiso", "1", "supervisor@mail.com",
                1, 1, 1);
        SolicitudesPermiso s4 = new SolicitudesPermiso("12345681",
                "1", "1982/05/24", "2020/05/24",
                "00:00", "05:00", 1, 1,
                "Quiero permiso", "1", "supervisor@mail.com",
                1, 1, 1);
        SolicitudesPermiso s5 = new SolicitudesPermiso("12345682",
                "1", "1982/05/24", "2020/05/24",
                "00:00", "05:00", 1, 1,
                "Quiero permiso", "1", "supervisor@mail.com",
                1, 1, 1);
        SolicitudesPermiso s6 = new SolicitudesPermiso("12345683",
                "1", "1982/05/24", "2020/05/24",
                "00:00", "05:00", 1, 1,
                "Quiero permiso", "1", "supervisor@mail.com",
                1, 1, 1);
