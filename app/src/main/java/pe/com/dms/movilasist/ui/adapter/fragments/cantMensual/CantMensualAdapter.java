package pe.com.dms.movilasist.ui.adapter.fragments.cantMensual;
...
public class CantMensualAdapter extends BasePaginationAdapter<String> {

    public static final String TAG = CantMensualAdapter.class.getSimpleName();

    private ItemTabCantDiariasBinding bindingBody;
    private ItemFooterPaginationBinding bindingFooter;

    public CantMensualAdapter() {
        super();
    }
