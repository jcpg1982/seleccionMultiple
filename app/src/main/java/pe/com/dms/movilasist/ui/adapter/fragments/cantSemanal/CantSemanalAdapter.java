package pe.com.dms.movilasist.ui.adapter.fragments.cantSemanal;
...
import pe.com.dms.movilasist.databinding.ItemTabCantSemanalesBinding;
import pe.com.dms.movilasist.ui.adapter.base.BasePaginationAdapter;

public class CantSemanalAdapter extends BasePaginationAdapter<String> {

    public static final String TAG = CantSemanalAdapter.class.getSimpleName();

    private ItemTabCantSemanalesBinding bindingBody;
    private ItemFooterPaginationBinding bindingFooter;

    public CantSemanalAdapter() {
        super();
    }
    ...
    protected RecyclerView.ViewHolder createBodyViewHolder(ViewGroup parent) {
        bindingBody = ItemTabCantSemanalesBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
