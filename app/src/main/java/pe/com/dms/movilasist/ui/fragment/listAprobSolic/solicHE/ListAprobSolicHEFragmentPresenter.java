...
public class ListAprobSolicHEFragmentPresenter extends BasePresenter<IListAprobSolicHEFragmentContract.View>
        implements IListAprobSolicHEFragmentContract.Presenter {

    String TAG = ListAprobSolicHEFragmentPresenter.class.getSimpleName();
    ...
    @Inject
    public ListAprobSolicHEFragmentPresenter() {
    ...
    public void setResultListApobSolic(ResultListApobSolic resultListApobSolic) {
        ...
        mRequestListAprobSolicPers.setIntTipoUso(2);
