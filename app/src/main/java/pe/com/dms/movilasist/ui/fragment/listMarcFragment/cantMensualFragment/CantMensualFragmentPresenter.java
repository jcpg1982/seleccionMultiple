...
public class CantMensualFragmentPresenter extends BasePresenter<ICantMensualFragmentContract.View>
        implements ICantMensualFragmentContract.Presenter {

    String TAG = CantMensualFragmentPresenter.class.getSimpleName();
    ...
    @Inject
    public CantMensualFragmentPresenter() {
    ...
    public void setModelListMarc(ResultListMarc resultListMarc) {
        ...
        mRequestListMarcGraphics.setIntTipo(TypeGraphics.MENSUAL);
