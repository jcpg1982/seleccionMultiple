...
public class FiltroListMarcFragmentPresenter extends BasePresenter<IFiltroListMarcFragmentContract.View>
        implements IFiltroListMarcFragmentContract.Presenter {

    String TAG = FiltroListMarcFragmentPresenter.class.getSimpleName();
    ...
    @Inject
    public FiltroListMarcFragmentPresenter() {
